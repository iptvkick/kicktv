export default function TutoriaisPage() {
  return (
    <div className="flex flex-col gap-6 p-8 w-full max-w-7xl mx-auto mt-4 sm:mt-16 md:mt-0">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-gray-900">Tutoriais e Onboarding</h1>
        <p className="text-sm text-gray-500 mt-1">Gerencie os vídeos e guias mostrados aos clientes.</p>
      </div>
      ...
      <div className="flex-1 bg-white rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-gray-100 p-8 flex items-center justify-center min-h-[400px]">
        <div className="text-center text-gray-400">
          ...
          <p>A gestão de tutoriais será implementada em breve.</p>
        </div>
      </div>
    </div>
  );
