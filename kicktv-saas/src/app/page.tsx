  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <header className="px-6 pt-12 pb-4 flex justify-between items-center">
        ...
        <Link href="/cliente/dashboard" className="text-sm font-semibold bg-white px-4 py-2 rounded-full shadow-sm">
          Login
        </Link>
      </header>
      ...
      <main className="px-6 flex-1 flex flex-col pt-4 pb-32">
        ...
        {/* Onboarding Devices (Accordions/Cards style) */}
      ...
      <div className="fixed bottom-0 left-0 w-full p-6 bg-gradient-to-t from-background via-background to-transparent pb-8">
        <Link href="/cliente/dashboard" className="w-full bg-accent text-white h-16 rounded-full flex items-center justify-center font-bold text-lg shadow-xl hover:scale-[1.02] transition-transform">
