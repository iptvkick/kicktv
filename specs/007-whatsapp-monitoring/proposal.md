# Proposal: WhatsApp Monitoring Playbook (v1.0)

## Visão Geral
O projeto tem como objetivo monitorar se os gerentes das unidades estão seguindo as 4 etapas obrigatórias de atendimento no WhatsApp, gerando histórico de 1 mês para depois definir KPIs e metas com o Daniel.
